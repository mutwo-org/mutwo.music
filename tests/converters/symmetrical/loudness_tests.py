...
class LoudnessToAmplitudeConverterTest(unittest.TestCase):
    def test_sone_to_phon(self):
        self.assertEqual(
            music_converters.LoudnessToAmplitudeConverter._sone_to_phon(1),
            40,
        )
        self.assertEqual(
            music_converters.LoudnessToAmplitudeConverter._sone_to_phon(2),
            50,
        )
        self.assertEqual(
            music_converters.LoudnessToAmplitudeConverter._sone_to_phon(0.5),
            31.39434452534506,
        )

    def test_convert(self):
        converter = music_converters.LoudnessToAmplitudeConverter()
