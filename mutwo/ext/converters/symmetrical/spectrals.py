...
class TwoPitchesToCommonHarmonicsConverter(converters.abc.Converter):
    ...
    ) -> tuple[tuple[int, ext_parameters.pitches.JustIntonationPitch], ...]:
        partial_tuple = tuple(
            (nth_partial, ext_parameters.pitches.JustIntonationPitch(nth_partial, 1))
    ...
    def convert(
    ...
    ) -> tuple[ext_parameters.pitches.CommonHarmonic, ...]:
        ...
        for nth_partial_for_first_pitch, partial in partials0:
            if partial in partials1:
                ...
                common_harmonic = ext_parameters.pitches.CommonHarmonic(
                    tuple(
                        ext_parameters.pitches.Partial(nth_partial, tonality)
